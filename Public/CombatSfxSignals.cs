...
public static class CombatSfxSignals
{
    ...
    public static event Action<CombatSfxTakedownType, Transform> OnTakedownImpact;
    ...
    public static void RaiseTakedownImpact(CombatSfxTakedownType type, Transform emitter)
        => OnTakedownImpact?.Invoke(type, emitter);
}
